...
label ch0_m_end2:
    ...
    m 2a "When performed out loud, it can be really..."
    m "Whatever. I know you don't wanna waste time listening to me talk about my poetry knowledge."
    m "I won't even bore you with a writing tip of the day."
    m "Just Kotonoha--{nw}"
    $ _history_list.pop()
...
label ch0_n_bad:
    ...
    m "(Yes, I know you're probably tired of hearing her say this stuff.)"
    m "(But the least you can do is wait, read her poem, and give at least {i}some{/i} feedback.)"
    m "(Please? I'd really appreciate it~)"
    mc "I'm not a writer!"
...
label ch0_n_good:
    ...
    mc "Like Monika said."
    n 4x "Uuuu...!"
    m "(Yes, I know you're probably tired of hearing her say this stuff.)" # Monika is off-screen.
    m "(But the least you can do is wait, read her poem, and give at least {i}some{/i} feedback.)"
    m "(Please? I'd really appreciate it~)"
...
label ch0_m_start:
    ...
    m "(Don't worry, I won't bother you for too long. I know you have more important things to get to.)"
